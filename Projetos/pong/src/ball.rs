use crate::{arena::Arena, player::Player, utils::rand_generator};
...
impl Ball {
    ...
    pub fn check_if_collide(&mut self, env: &Arena, p1: &mut Player, p2: &mut Player) {
        ...
        if self.x == p2.racket.x && (p2.racket.y..=p2.racket.height).contains(&self.y) {
